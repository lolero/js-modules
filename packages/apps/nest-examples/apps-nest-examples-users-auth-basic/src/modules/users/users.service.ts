...
export class UsersService implements AuthUsersService {
  ...
  async findMany(
    ...
    if (usersDtoFindMany.createdAtRange) {
      const createdAtRange = utilGetFindManyDateRange(
    ...
    if (usersDtoFindMany.updatedAtRange) {
      const updatedAtRange = utilGetFindManyDateRange(
    ...
    if (usersDtoFindMany.deletedAtRange) {
      const deletedAtRange = utilGetFindManyDateRange(
  ...
  async updateManyPartial(
    ...
    utilCrossCheckIds(ids, usersEntities);
