...
/**
 * Date-range picker pair bound to a URL search-param range. `searchParams` and
 * `setSearchParams` are injected by the consumer (react-router `useSearchParams`
 * or a Next.js adapter), keeping the component router-agnostic.
 * @param props - Component props.
 * @param props.rangeKey - Range key read/written in the search params.
