...
import { RangeButtonValue } from '@mui/x-charts-pro/ChartsToolbarPro';
...
interface Preset {
  ...
  label: string;
  /** A readable representation of `value`, displayed above the chart. */
  code: string;
  /** The range value passed to `initialZoom`. */
  value: RangeButtonValue;
}

// Time axis: calendar intervals, an absolute date range, a function, or a reset.
const linePresets: Preset[] = [
  {
    label: '5Y',
